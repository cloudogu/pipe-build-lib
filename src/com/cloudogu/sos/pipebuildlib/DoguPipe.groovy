...
class DoguPipe extends BasePipe {
    ...
    DoguPipe(script, Map config) {
        ...
        ecoSystem.metaClass.writeVagrantConfiguration = { String mountPath, String machineType = "c4-standard-8" ->
...
EOF
            ...
            group.stage("Provision", PipelineMode.INTEGRATION) {
                ...
                ecoSystem.provision(doguDir, "c4-standard-8")
            }
